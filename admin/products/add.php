...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $addNewProduct = new Products();

    $addNewProduct->name = $_POST['name'];
    $addNewProduct->quantity = $_POST['quantity'];
    $addNewProduct->price = $_POST['price'];
...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <button name="addProductBTN" type="submit">Add Product</button>
        </form>
    </div>
